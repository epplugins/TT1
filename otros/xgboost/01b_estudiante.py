...
# Todas la variables que se pueden usar para este análisis, con sala y no SEDE. Sin pa1.
...
bst.save_model("modelo_01b_estudiante_sala_aucpr.json")
print("\nModelo guardado en modelo_01b_estudiante_sala_aucpr.json")
