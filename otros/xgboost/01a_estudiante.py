...
# Todas la variables que se pueden usar para este análisis con SEDE y no sala, sin pa1.
...
bst.save_model("modelo_01a_estudiante_aucpr.json")
print("\nModelo guardado en modelo_01a_estudiante_aucpr.json")
