...
# sala, y sin pa1, sin pa1_prom y sin abandona1_p.
...
columnas = ['cuat', 'MATERIA', 'codCarrera', 'facultad',
        'extranjero', 'edad', 'turno', 'n_alum', 'p_ext',
        'recurso', 'p_recursa', 'sala']

X = df2[columnas].copy()
y = df2[['objetivo']].copy()

# Columnas con variables categóricas:
cats = ['cuat', 'MATERIA', 'codCarrera', 'facultad', 'extranjero', 'edad',
       'turno', 'sala']
for col in cats:
...
np.savetxt("salida_02g_average_precision_scores.txt", aps)
importancia.to_csv("salida_02g_importancias.csv")

print("Resultados guardados en")
print("salida_02g_average_precision_scores.txt y")
print("salida_02g_importancias.csv")
