# Idem 02_repeticiones agregando variables dummies para las categóricas.
...
columnas = ['cuat', 'SEDE', 'MATERIA', 'pa1', 'pa1_prom', 'codCarrera', 'facultad',
        ...
        'recurso', 'p_recursa', 'abandona1_p', 'objetivo']
df2 = df2[columnas]
...
np.savetxt("salida_03a_average_precision_scores.txt", aps)
importancia.to_csv("salida_03a_importancias.csv")

print("Resultados guardados en")
print("salida_03a_average_precision_scores.txt y")
print("salida_03a_importancias.csv")
