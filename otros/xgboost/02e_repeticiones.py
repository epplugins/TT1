...
columnas = ['cuat', 'MATERIA', 'pa1', 'pa1_prom', 'codCarrera', 'facultad',
        'extranjero', 'edad', 'prom_edad', 'turno', 'n_alum', 'p_ext',
        'recurso', 'p_recursa', 'abandona1_p', 'sala']
...
np.savetxt("salida_02e_average_precision_scores.txt", aps)
importancia.to_csv("salida_02e_importancias.csv")

print("Resultados guardados en")
print("salida_02e_average_precision_scores.txt y")
print("salida_02e_importancias.csv")
