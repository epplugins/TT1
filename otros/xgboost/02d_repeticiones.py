...
# Con SEDE, sin pa1 y sin abandona1_p.
...
np.savetxt("salida_02d_average_precision_scores.txt", aps)
importancia.to_csv("salida_02d_importancias.csv")

print("Resultados guardados en")
print("salida_02d_average_precision_scores.txt y")
print("salida_02d_importancias.csv")
