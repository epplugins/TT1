# Idem 05_estudiante_menos_variables.py pero sin abandona1_p.
...
np.savetxt("salida_05b_average_precision_scores.txt", aps)
importancia.to_csv("salida_05b_importancias.csv")

print("Resultados guardados en")
print("salida_05b_average_precision_scores.txt y")
print("salida_05b_importancias.csv")
