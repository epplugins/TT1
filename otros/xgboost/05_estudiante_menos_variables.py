# Idem 03_estudiante usando menos variables.
...
columnas = ['cuat', 'MATERIA', 'codCarrera', 'facultad',
        'prom_edad', 'turno', 'n_alum', 'p_ext',
        'p_recursa', 'sala', 'abandona1_p']

X = df2[columnas].copy()
y = df2[['objetivo']].copy()

# Columnas con variables categóricas:
cats = ['cuat', 'MATERIA', 'codCarrera', 'facultad', 'turno', 'sala']
for col in cats:
...
np.savetxt("salida_05_average_precision_scores.txt", aps)
importancia.to_csv("salida_05_importancias.csv")

print("Resultados guardados en")
print("salida_05_average_precision_scores.txt y")
print("salida_05_importancias.csv")
