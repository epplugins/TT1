...
# usando pa1, quitando otras variables importantes.
...
columnas = ['cuat', 'MATERIA', 'pa1', 'codCarrera', 'facultad',
...
np.savetxt("salida_02f_average_precision_scores.txt", aps)
importancia.to_csv("salida_02f_importancias.csv")

print("Resultados guardados en")
print("salida_02f_average_precision_scores.txt y")
print("salida_02f_importancias.csv")
