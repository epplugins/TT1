...
# Con SEDE y pa1 (sin abandona1_p).
...
np.savetxt("salida_02c_average_precision_scores.txt", aps)
importancia.to_csv("salida_02c_importancias.csv")

print("Resultados guardados en")
print("salida_02c_average_precision_scores.txt y")
print("salida_02c_importancias.csv")
