...
np.savetxt("salida_02a_average_precision_scores.txt", aps)
importancia.to_csv("salida_02a_importancias.csv")

print("Resultados guardados en")
print("salida_02a_average_precision_scores.txt y")
print("salida_02a_importancias.csv")
