...
# Notas Altas.
# Todas la variables que se pueden usar para este análisis con sala y no SEDE.
...
bst.save_model("modelo_31_altas_aucpr.json")
print("\nModelo guardado en modelo_31_altas_aucpr.json")
